...
class DQNAgent:
    def __init__(self, action_size):
        ...
        self.summary_writer = tf.summary.FileWriter(
            'summary/frostbite_dqn', self.sess.graph)
        self.sess.run(tf.global_variables_initializer())

        if self.load_model:
         self.model.load_weights("frostbite_dqn.h5")
...
if __name__ == "__main__":
    ...
    for e in range(10):
        ...
        print("After processing: " + str(np.array(state).shape))
    ...
    #         env.render()
        ...
        # if e % 1000 == 0:
        #     agent.model.save_weights("frostbite_dqn.h5")
